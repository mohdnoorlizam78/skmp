...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <h3>BORANG PERMOHONAN KEMASUKAN SEPENUH MASA</h3>
        ...
        <form action="{{ route('tvet.store') }}" method="post">
            @csrf
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <select id="kursus_id" name="kursus_id1"
                                class="form-control
                                custom-margin">
                                <option value="">-- Kursus Pilihan Pertama --</option>
                                @foreach ($senaraiKursus as $kursus)
                                    <option value="{{ $kursus->id }}"
                                        {{ old('kursus_id') == $kursus->id ? 'selected' : 'Tiada' }}>
                ...
                <div class="mb-3">
                    <div class="value">
                        <div class="input-group">
                            <select id="kursus_id" name="kursus_id2"
                                class="form-control
                                custom-margin">
                                <option value="">-- Kursus Pilihan Kedua --</option>
                                @foreach ($senaraiKursus as $kursus)
                                    <option value="{{ $kursus->id }}"
                ...
                <div class="mb-3">
                    <div class="value">
                        <div class="input-group">
                            <select id="kursus_id" name="kursus_id3"
                                class="form-control
                                custom-margin">
                                <option value="">-- Kursus Pilihan Ketiga --</option>
                                @foreach ($senaraiKursus as $kursus)
                                    <option value="{{ $kursus->id }}"
                                        {{ old('kursus_id') == $kursus->id ? 'selected' : null }}>
                                        {{ $kursus->nama_kursus }}</option>
