    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="tableTujuan" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Bil</th>
                                <th>Nama tujuan</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <a href="{{ route('tujuan.edit', $tujuan->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                        &nbsp;
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('tujuan.store') }}">
                                @csrf
                                <div class="mb-3">
                                    <label for="nama_tujuan" class="col-form-label">Nama tujuan:</label>
