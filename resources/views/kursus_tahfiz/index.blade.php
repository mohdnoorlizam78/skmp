...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>SENARAI KURSUS TVET TAHFIZ</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Utama</a></li>
                    <li class="breadcrumb-item active">senarai kursus tvet tahfiz</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="tableKursusTahfiz" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Bil</th>
                                <th>Nama Kursus Tvet Tahfiz</th>
                                <th>Status</th>
                                <th></th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="{{ route('kursus_tahfiz.edit', $kursus->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                        &nbsp;
                                        <form action="{{ route('kursus_tahfiz.destroy', $kursus->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('kursus_tahfiz.store') }}">
                                @csrf
